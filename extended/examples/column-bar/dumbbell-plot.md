...
See also: Horizontal dumbbell plot demo.
Key implementation details
The dumbbells are just narrow columns with openValueYField set to the open value (so that they don't start on the axis).
XY chart
Column series
Bullets
