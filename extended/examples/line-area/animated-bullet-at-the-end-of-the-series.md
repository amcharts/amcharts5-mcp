...
To achieve this effect we create a bullet comprising of two circles. Then we animate both radius and opacity on one of them using built-in animation tools. And that's it.
Animations
Bullets
