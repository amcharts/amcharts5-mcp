...
We create two value axes and position them on the opposite sides of the plot area. To do that we set opposite: true on the renderer of the second axis. When creating our column series we set there yAxis: yAxis0 (our first value axis) and on the line series we set the yAxis to yAxis1.
XY chart
Value axis
