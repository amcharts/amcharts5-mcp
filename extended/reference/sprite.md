...
Extends: Entity
Extended by: Graphics, Container, Picture
...
- **dataItem** (`DataItem | undefined`) — A DataItem used for this element. NOTE: data item is being assigned automatically in most cases where it matters. Use this accessor to set data item only if you know what you're doing.
- **events** (`SpriteEventDispatcher`) — (no description)
- **parent** (`Container | undefined`) — Parent Container of this element.
