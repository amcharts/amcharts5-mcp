...
Inheritance
ITreeDataItem extends ILinkedHierarchyDataItem.
ITreeDataItem is not extended by any other symbol.
Properties
...
- **children** (`Array`) — An array of children data items.
- **parent** (`DataItem`) — Parent data item.
