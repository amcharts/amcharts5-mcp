...
Inheritance
ISuperTrendSettings extends IIndicatorSettings.
ISuperTrendSettings is not extended by any other symbol.
Properties
...
- **lowerColor** (`Color`) — (no description)
- **multiplier** (`undefined | number`) — (no description)
- **upperColor** (`Color`) — (no description)
