---
title: "IGanttDateAxisDataItem"
type: "interface"
source: "https://www.amcharts.com/docs/v5/reference/iganttdateaxisdataitem/"
scraped: "2026-03-15"
---

Inheritance
IGanttDateAxisDataItem extends IDateAxisDataItem.
IGanttDateAxisDataItem is not extended by any other symbol.
Properties
...
- **active** (`undefined | false | true`) — Flag is set to active if an axis range is added to this data item.
