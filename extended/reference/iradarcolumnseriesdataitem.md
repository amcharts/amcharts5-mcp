---
title: "IRadarColumnSeriesDataItem"
type: "interface"
source: "https://www.amcharts.com/docs/v5/reference/iradarcolumnseriesdataitem/"
scraped: "2026-03-15"
---

Inheritance
IRadarColumnSeriesDataItem extends IBaseColumnSeriesDataItem.
IRadarColumnSeriesDataItem is not extended by any other symbol.
Properties
...
Extends: IBaseColumnSeriesDataItem

> **Note:** This class also inherits all settings, properties, methods, and events from IBaseColumnSeriesDataItem (and its ancestors). Use `get_doc` or `get_core_reference` with the parent class name to see inherited members.

## Properties

- **endAngle** (`undefined | number`) — Actual end angle of the column in degrees.
- **innerRadius** (`undefined | number`) — Actual inner radius of the column in pixels.
- **radius** (`undefined | number`) — Actual radius of the column in pixels.
- **startAngle** (`undefined | number`) — Actual start angle of the column in degrees.
